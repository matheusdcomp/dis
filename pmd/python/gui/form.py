...
Radiobutton(base, text="Female", padx =15,variable=vars, value=2).place(x=250,y=240)  
Radiobutton(base, text="others", padx=15, variable=vars, value=3).place(x=350,y=240)  
