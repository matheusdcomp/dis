...
public class Exemplo01 {
	...
	public static void main(String[] args) {
		...
		System.out.format("%s eh igual a %s? %b%n", arq1, arq2, arq1.compareTo(arq2));
		System.out.format("Nome do arquivo: %s%n", arq1.getFileName());
		System.out.format("1o diretorio: %s%n", arq1.getName(0));
		System.out.format("Qtde de elementos no path: %d%n", arq1.getNameCount());
		System.out.format("Diretorio do arquivo: %s%n", arq1.getParent());
